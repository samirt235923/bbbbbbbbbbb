...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Use our 4.0 GPA Calculator to calculate your GPA using the standard 4.0 grading scale. Enter courses, credits, and grades to instantly calculate your GPA.',
    type: 'website',
    url: 'https://toptopgpacalculator.com/gpa-calculators/4-0-scale-gpa-calculator',
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://toptopgpacalculator.com/gpa-calculators/4-0-scale-gpa-calculator',
  },
};
